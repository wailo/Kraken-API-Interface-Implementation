...
//!
*/
boost::optional<JSONNode> kraken_interface::get_asset_info(const boost::optional<std::string>& info,
...
//!
*/
boost::optional<JSONNode> kraken_interface::add_standard_order(const order& order_) {
